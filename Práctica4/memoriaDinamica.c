...
void movimientosCaballo(struct caballo c, char **tablero){
    int i, j, x, y;
...
void movimientosAlfil(struct alfil a, char **tablero){
    int i, j, x, y;
    int dx[] = {1, 1, -1, -1};
    int dy[] = {1, -1, 1, -1};
...
void movimientosTorre(struct torre t,char **tablero){
    int i, x, y;
...
void movimientosReina(struct reina q, char** tablero){
    int i, x, y;
...
void movimientosRey(struct rey k, char **tablero){
    int i, j, x, y;
