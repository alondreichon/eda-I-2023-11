...
while (1){
printf("Bienvenido va a realizar una operacion:\n");
printf ("1) Insertar.\n");
...
struct Node* head = NULL;
 ...
 insertEnd(&head, 9);
  ...
  insertAfter(head, "%i", &elemento1);

  // se inserta 15 después del segundo nodo
  insertAfter(head->next, "%i", &elemento1);
    printf("Se ha insertado el elemento %i en la estructura!\n", elemento1);
    printf("\n");
     displayList(head);
}
...
struct Node* head = NULL;
 ...
 insertEnd(&head, 9);
  ...
  deleteNode(&head, head->next->next->next->next->next);
    ...
    printf("Se ha eliminado el elemento %i en la estructura!\n", elemento2);
    printf("\n");
     displayList(head);
}
